...
namespace StockTrader.Application.Factories
{
    public static class MessageFactory
    {
        ...
        public static OrderMessage ToOrderMessage(this Order order)
            => new OrderMessage(MessageSource.OrderService, new OrderDto(order.Id, order.PersonId, order.Ticker, order.Quantity, order.OrderStatus, order.OrderAction, order.StatusReason));
    }
}
